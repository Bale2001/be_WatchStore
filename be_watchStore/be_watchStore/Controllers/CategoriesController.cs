...
namespace be_watchStore.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public CategoriesController(WatchShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Category>> PostCategory(Category category)
        {
          if (_context.Categories == null)
          {
              return Problem("Entity set 'WatchShopContext.Categories'  is null.");
          }
        ...
        public async Task<ActionResult<List<ProductModel.getAllCategory>>> getAllCategory()
        {
            try
            {
                if (_context.Categories == null)
                ...
                var result = _context.Categories.Select(c => new ProductModel.getAllCategory
                {
                    id = c.CatId,
                    name = c.CatName
                });
